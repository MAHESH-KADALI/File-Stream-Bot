    ...
    try:
       await b.send_message(chat_id=m.chat.id,text="HELLO",quote=True)
                ...
                await b.send_message(
                    chat_id=m.chat.id,
                    text="ɪ  ᴀᴍ  ᴍᴀɪɴᴛᴀɪɴᴇᴅ  ʙʏ  [MAHESH](https://telegram.me/maheshsirop)",
                    
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton("ᴅᴇᴠᴇʟᴏᴘᴇʀ   💻", url=f"https://telegram.me/maheshsirop")
                            ]
                        ]
                    ),
       ...
       await b.send_message(chat_id=m.chat.id,text="HELLO",quote=True)
                ...
                await b.send_message(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton("FOLLOW ME", url=f"https://Instagram.com/mahesh_namikaze")
                            ]
                        ]
                    ),
